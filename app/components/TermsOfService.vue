    ...
    <div class="container">
        <b-card class="XDC-card">
            ...
            <div class="container">
                ...
                <h5>1. Risks related to the use of MasterNode-App </h5>
                <p>
                    MasterNode-App will not be responsible for any losses, damages or claims arising from
                ...
                <p>
                    (2) Software problems of MasterNode-App and/or any cryptocurrency-related software
                ...
                <p>
                    The users of MasterNode-App are solely responsible to determinate what, if any, taxes apply
                    to their crypto-currency transactions. The owners of, or contributors to, MasterNode-App are NOT
                ...
                <h5>5. Arbitration</h5>
                <p>
                    The user of MasterNode-App agrees to arbitrate any dispute arising from or in connection with
