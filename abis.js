...
let XDCValidatorAbi = require('./contracts/XDCValidator.json')
...
let BlockSignerAbi = require('./contracts/BlockSigner.json')
...
let XDCRandomizeAbi = require('./contracts/XDCRandomize.json')
...
let MigrationsAbi = require('./contracts/Migrations.json')
data = JSON.stringify(MigrationsAbi, null, 2)
fs.writeFileSync('./abis/Migrations.json', data)

// copy & save SafeMath
let SafeMathAbi = require('./contracts/SafeMath.json')
